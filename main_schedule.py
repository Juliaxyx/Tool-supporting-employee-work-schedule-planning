...
def main_schedule():
    ...
    #Wyjście    
            try:
                ...
                print()           
            for key in keys.values():
                employees_chosen[key+shift_list[0]+'-main'] = values[key+shift_list[0]+'-main']
                employees_chosen[key+shift_list[0]+'-support'] = values[key+shift_list[0]+'-support']
                employees_chosen[key+shift_list[1]+'-main'] = values[key+shift_list[1]+'-main']
